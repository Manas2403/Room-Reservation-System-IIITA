    ...
    <div class="limiter">
        <div class="container-login100" style="gap:2rem">
            ...
            <div class="wrap-login100 p-t-30 p-b-50">
                ...
                <form class="login100-form validate-form p-b-33 p-t-5" action="controller/addLoc.php" onsubmit="return validateFormDept()" method="post">

                    <div >
                        <input id="dept" class="input100" type="text" name="loc" placeholder="Location" onkeyup="checkDeptName(this.value)">
