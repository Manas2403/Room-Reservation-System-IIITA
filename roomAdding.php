...
<header class="s-header header">
    ...
    <nav class="header__nav-wrap">
        ...
        <ul class="header__nav">
            ...
            <li><a href="roomAdding.php">Add Room</a></li>
    ...
    <div class="limiter">
        <div class="container-login100" >
            ...
            <div class="wrap-login100 p-t-30 p-b-50">
                ...
                <form class="login100-form validate-form p-b-33 p-t-5" action="controller/addRoom.php" method="post">

                <p class="input100">Room Location</p>
                    <select id="roomlocation" name="roomlocation" class="input102">
                        <option value="select">SELECT</option>
                        <?php
                        $locationList = getAllRooms();
